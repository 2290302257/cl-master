...
namespace Coffee.UIEffects
{
    ...
    public class UIShadow : BaseMeshEffect, IParameterTexture
    {
        ...
        protected override void OnEnable()
        {
            ...
            _uguiEffect = GetComponent<UGUIEffect>();
            if (!_uguiEffect) return;

            paramTex = _uguiEffect.paramTex;
...
// #endif
        ...
        public override void ModifyMesh(VertexHelper vh, Graphic graphic)
        {
            ...
            //================================
            {
                _uguiEffect = _uguiEffect ? _uguiEffect : GetComponent<UGUIEffect>();
                var start = s_Verts.Count - _graphicVertexCount;
                var end = s_Verts.Count;

                if (paramTex != null && _uguiEffect && _uguiEffect.isActiveAndEnabled)
                {
                    paramTex.SetData(this, 0, _uguiEffect.effectFactor); // param.x : effect factor
            ...
            float y, bool alpha)
        {
            ...
            var normalizedIndex = paramTex != null && _uguiEffect && _uguiEffect.isActiveAndEnabled
