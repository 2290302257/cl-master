...
namespace Alurax
{
	...
	[AddComponentMenu("UGUI/Tween/Tween PositionY")]
	public class TweenPositionY : UITweener
	{
		...
		public float value
		{
			...
			set { cachedTransform.anchoredPosition = new Vector2(cachedTransform.anchoredPosition.x, value); }
		}
		...
		static public TweenPositionY Begin(GameObject go, float duration, float pos)
		{
